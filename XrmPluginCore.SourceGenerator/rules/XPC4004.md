...
**Note:** This rule only applies to the modern `WithPreImage()`/`WithPostImage()` API. For the legacy `AddImage()` API, see [XPC4005](XPC4005.md).
...
- [XPC4005: Consider using modern image registration API](XPC4005.md)
