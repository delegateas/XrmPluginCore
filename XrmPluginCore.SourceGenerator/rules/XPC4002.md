# XPC4002: Handler signature does not match registered images
...
This is a **warning** to allow the initial build to succeed so that the source generator can create the wrapper types. Once the types exist, this diagnostic escalates to [XPC4003](XPC4003.md) (Error).
...
- [XPC4003: Handler signature does not match registered images (types exist)](XPC4003.md)
