...
namespace XrmPluginCore.Tests
{
    ...
    public class TypeSafePluginTests
    {
        ...
        public void AccountPlugin_ShouldHandleNoImages()
        {
            ...
            // No images
            mockProvider.SetupPreEntityImages(new EntityImageCollection());
            mockProvider.SetupPostEntityImages(new EntityImageCollection());
        ...
        [Fact]
        public void AccountPlugin_PreImage_ToEntity_ShouldReturnEarlyBoundEntity()
        {
            // Arrange
            var plugin = new TypeSafeAccountPlugin();
            var mockProvider = new MockServiceProvider();
            ...
            // Assert - ToEntity<T>() should return early-bound entity
            plugin.LastPreImage.Should().NotBeNull();

            var account = plugin.LastPreImage.ToEntity<Account>();
